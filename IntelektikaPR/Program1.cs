...
namespace IntelektikaPR
{
    class Program
    {
        ...
        static int convWidth = 24;
        static int convHeigth = 24;
        ...
        public static List<double> XValidation(int dataSetCount, string data)
        {
            ...
            for (int i = 0; i < dataSetCount; i++)
            {
                ...
                double acc = (double)corr / count * 100;
                result.Add(acc);
        ...
        static void Main(string[] args)
        {
            ...
            //    if (rez == "0") teisingai++;        
            //}
            //double acc = (double)teisingai / 300 * 100;
            //Console.WriteLine("Digit 0 atpažinimas:");
            //Console.WriteLine("tikslumas = " + teisingai + " / 300 " + string.Format("{0:f1}", acc) + "%");
